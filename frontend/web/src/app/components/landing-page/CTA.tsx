...
export function CTA() {
  return (
    <section className="px-8 py-32 text-center relative overflow-hidden">
      <div className="max-w-4xl mx-auto glass-card border border-outline-variant/10 rounded-[3rem] p-16 md:p-24 relative z-10">
        ...
        <p className="text-on-surface-variant text-lg mb-12 max-w-lg mx-auto">
          Junte-se a mais de 15.000 MEIs que transformaram sua gestão financeira em 1 minuto.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/register"
            className="px-12 py-5 rounded-2xl bg-on-surface text-surface-dim font-bold text-xl hover:bg-primary-fixed transition-all active:scale-95"
          >
            Experimentar Grátis
          </Link>
        </div>
