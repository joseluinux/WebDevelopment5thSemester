...
export function Header() {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-[#0A0A0C]/70 backdrop-blur-2xl border-b border-outline-variant/10">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#131315]/95 backdrop-blur-xl px-8 py-4 flex flex-col gap-4 border-t border-outline-variant/10">
          ...
          <Link
            href="/register"
            className="text-sm font-bold text-center py-2 px-4 rounded-xl bg-linear-to-br from-primary-container to-primary text-on-primary"
            onClick={() => setIsMenuOpen(false)}
          >
            Criar Conta
          </Link>
